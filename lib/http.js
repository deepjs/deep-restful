...
define(["require", "deepjs/deep", "./store", "./cache-sheet"], function(require, deep, Store, cacheSheet) {
	"use strict";
	...
	var noBody = function(old) {
		return function(id, options) {
			...
			//console.log("HTTP NOBODY : ", (deep.Promise.context.rootPath ||  deep.globals.rootPath || "norootPath") , this.baseURI , id);
			options = options || {};
	...
	var clientStoreProto = {
		...
		rpc: deep.compose.around(function(old) {
			return function(method, params, id, options) {
				...
				id = (deep.Promise.context.rootPath ||  deep.globals.rootPath || "") + this.baseURI + (id || "");
		...
		bulk: deep.compose.around(function(old) {
			return function(array, options) {
				...
				return old.call(this, (deep.Promise.context.rootPath ||  deep.globals.rootPath || "") + this.baseURI, array, options);
			};
		}),
